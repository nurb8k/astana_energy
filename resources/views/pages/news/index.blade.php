            ...
            <div class="container-md">
                <div class="single-news-inner">
                    ...
                    <div class="single-news-article">
                        ...
                        <div class="single-news-date">Опубликовано: {{ \Carbon\Carbon::parse($latest->time_publish)->format('d.m.Y') }}
                            г.</div>
                        <p class="single-news-description">{!! Str::limit($latest->desc_ru, 180, '...') !!}</p>
                        <a href="{{route('news.show',$latest->id)}}" class="btn btn-outline btn-icon-right btn-hover-fil mt-1">
                            <span>Подробнее</span>
                        ...
                        @foreach($other_news as $n)
                            <div class="news-item bg-grey">
                                ...
                                <div class="news-item-article">
                                    ...
                                    <div class="news-item-date">{{ \Carbon\Carbon::parse($n->time_publish)->format('d.m.Y') }} г</div>
