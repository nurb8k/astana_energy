                    ...
                    <div class="news-list">
                        <div class="news-item bg-grey">
                            ...
                            <div class="news-item-article">
                                <h5 class="news-item-title">qweq</h5>
                                <div class="news-item-date">04.10.2023 г</div>
                        ...
                        <div class="news-item bg-grey">
                            <div class="news-item-preview" style="background-image: url(http://localhost:8001/storage/news_images/aiRQy0vhHbfFuLT0SLdHhw7qKg5gLqh3TXiVWVXM.jpg);"></div>
                            <div class="news-item-article">
                                <h5 class="news-item-title">asdasdasd</h5>
                                <div class="news-item-date">13.10.2023 г</div>
                                <a href="http://localhost:8001/news/3" class="detail-link">
                                    <span>Перейти</span>
                                    <img src="http://localhost:8001/user/assets/img/icons/right-arrow.svg" alt="News link icon" class="detail-link-icon">
                                </a>
                            </div>
