    ...
    @if(app()->getLocale() == 'kz')
        <div class="govs-inner">
            ...
            <div class="gov__description">
                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z1500000401#z1" target="_blank">Ақпаратқа қол жеткізу туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z1500000402#z33" target="_blank">Қайырымдылық туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z1300000088" target="_blank">Мемлекеттік көрсетілетін қызметтер туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z040000586_" target="_blank">
                ...
                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/V1800017561" target="_blank">Мемлекет кепілдік берген заң көмегі туралы

                    </a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z000000107_" target="_blank">Әкімшілік рәсімдер туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z1500000418" target="_blank">Ақпараттандыру туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z990000451_" target="_blank">
                        Бұқаралық ақпарат құралдары туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z070000221_" target="_blank">Жеке және заңды тұлғалардың өтiнiштерiн қарау тәртiбi туралы</a></p>
                ...
                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/K080000095_" target="_top">Қазақстан Республикасының Бюджет кодексі</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/K950001000_" target="_blank">ҚР Конституциясы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z970000151_" target="_blank">Қазақстан Республикасындағы тiл туралы</a></p>

                <p><a class="text-primary" href="https://adilet.zan.kz/rus/docs/Z1500000416" target="_blank">ҚР "Мемлекеттік қызмет туралы" заңы
