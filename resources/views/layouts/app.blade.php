...
<nav class="navbar">
    ...
    <div class="navbar-body">
        <ul class="vertical-nav">
            ...
            <li>
                ...
                <div class="hover-menu">
                    <ul>
                        ...
                        <li><a href="#">Отчеты по исполнению тарифной сметы</a></li>
                        <li><a href="#">Отчеты перед потребителями и иными заинтересованными лицами</a></li>
                        <li><a href="#">Отчеты по исполнению инвестиционной программы</a></li>
            ...
            <li @if(Route::is("press.*") || Route::is("news.*")) class="vertical-nav__active" @endif>
                ...
                <div class="hover-menu">
                    <ul>
                        <li class="vertical-nav__active"><a @if(Route::is("press.index")) class="nav_active" @endif  href="{{route('press.index')}}">Пресс-центр</a></li>
    ...
    <div class="navbar-footer">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#343C5C" class="bi bi-telephone-fill" viewBox="0 0 16 16">
